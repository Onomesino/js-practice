...
let groundBottom = parseInt(window.getComputedStyle(character).getPropertyValue
('bottom'));
let groundHeight = parseInt(window.getComputedStyle(character).getPropertyValue
('height'));
let IsJumping = false;
let upTime;
let downTime;
